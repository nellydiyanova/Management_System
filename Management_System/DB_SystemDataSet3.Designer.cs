...
namespace Management_System {
    ...
    public partial class DB_SystemDataSet3 : global::System.Data.DataSet {
        ...
        public partial class CompaniesDataTable : global::System.Data.TypedTableBase<CompaniesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CompaniesRow AddCompaniesRow(int id_company, string bullstat, string company, string MOL, string phone, string city, string address, string email) {
        ...
        public partial class CompaniesRow : global::System.Data.DataRow {
            ...
            public string bullstat {
                get {
                    try {
                        return ((string)(this[this.tableCompanies.bullstatColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'bullstat\' in table \'Companies\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableCompanies.bullstatColumn] = value;
                }
            }
            ...
            public string MOL {
                get {
                    return ((string)(this[this.tableCompanies.MOLColumn]));
                }
                set {
                    this[this.tableCompanies.MOLColumn] = value;
                }
            }
            ...
            public bool IsbullstatNull() {
                return this.IsNull(this.tableCompanies.bullstatColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetbullstatNull() {
                this[this.tableCompanies.bullstatColumn] = global::System.Convert.DBNull;
            }
...
namespace Management_System.DB_SystemDataSet3TableAdapters {
    ...
    public partial class CompaniesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Companies] WHERE (([id_company] = @Original_id_company) AND ((@IsNull_bullstat = 1 AND [bullstat] IS NULL) OR ([bullstat] = @Original_bullstat)) AND ((@IsNull_company = 1 AND [company] IS NULL) OR ([company] = @Original_company)) AND ([MOL] = @Original_MOL) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Companies] ([id_company], [bullstat], [company], [MOL], [phone], [city], [address], [email]) VALUES (@id_company, @bullstat, @company, @MOL, @phone, @city, @address, @email);
SELECT id_company, bullstat, company, MOL, phone, city, address, email FROM Companies WHERE (id_company = @id_company)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Companies] SET [id_company] = @id_company, [bullstat] = @bullstat, [company] = @company, [MOL] = @MOL, [phone] = @phone, [city] = @city, [address] = @address, [email] = @email WHERE (([id_company] = @Original_id_company) AND ((@IsNull_bullstat = 1 AND [bullstat] IS NULL) OR ([bullstat] = @Original_bullstat)) AND ((@IsNull_company = 1 AND [company] IS NULL) OR ([company] = @Original_company)) AND ([MOL] = @Original_MOL) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)));
SELECT id_company, bullstat, company, MOL, phone, city, address, email FROM Companies WHERE (id_company = @id_company)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_company, bullstat, company, MOL, phone, city, address, email FROM dbo.C" +
                "ompanies";
        ...
        public virtual int Fill(DB_SystemDataSet3.CompaniesDataTable dataTable) {
        ...
        public virtual DB_SystemDataSet3.CompaniesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DB_SystemDataSet3.CompaniesDataTable dataTable = new DB_SystemDataSet3.CompaniesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DB_SystemDataSet3.CompaniesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id_company, string Original_bullstat, string Original_company, string Original_MOL, string Original_phone, string Original_city, string Original_address, string Original_email) {
        ...
        public virtual int Insert(int id_company, string bullstat, string company, string MOL, string phone, string city, string address, string email) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_id_company));
            if ((Original_bullstat == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string bullstat, string company, string MOL, string phone, string city, string address, string email, int Original_id_company, string Original_bullstat, string Original_company, string Original_MOL, string Original_phone, string Original_city, string Original_address, string Original_email) {
            return this.Update(Original_id_company, bullstat, company, MOL, phone, city, address, email, Original_id_company, Original_bullstat, Original_company, Original_MOL, Original_phone, Original_city, Original_address, Original_email);
        }
    }
